...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      deploySlippageBps: ["management", "deploySlippageBps"],
      ...
      gmgnRejectPumpTop: ["gmgn", "rejectPumpTop"],
      ...
      gmgnPullbackMinRsi5m: ["gmgn", "indicatorRules", "pullbackMinRsi5m"],
      gmgnPullbackMaxRsi5m: ["gmgn", "indicatorRules", "pullbackMaxRsi5m"],
      gmgnPullbackMinRsi15m: ["gmgn", "indicatorRules", "pullbackMinRsi15m"],
      gmgnPullbackMaxRsi15m: ["gmgn", "indicatorRules", "pullbackMaxRsi15m"],
      gmgnPullbackMinBbPosition5m: ["gmgn", "indicatorRules", "pullbackMinBbPosition5m"],
      gmgnPullbackMaxBbPosition5m: ["gmgn", "indicatorRules", "pullbackMaxBbPosition5m"],
      gmgnPullbackRequire5mAboveSupertrend: ["gmgn", "indicatorRules", "pullbackRequire5mAboveSupertrend"],
      gmgnPullbackRequire15mAboveSupertrend: ["gmgn", "indicatorRules", "pullbackRequire15mAboveSupertrend"],
      gmgnPullbackRequire15mBullishSupertrend: ["gmgn", "indicatorRules", "pullbackRequire15mBullishSupertrend"],
      // chart indicators
