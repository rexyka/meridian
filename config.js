...
export const config = {
  ...
  gmgn: {
    ...
    rejectPumpTop: gmgnValue("rejectPumpTop", "gmgnRejectPumpTop", true),
    ...
    indicatorRules: (() => {
      ...
      return {
        ...
        pullbackMinRsi5m:         r.pullbackMinRsi5m         ?? 35,
        pullbackMaxRsi5m:         r.pullbackMaxRsi5m         ?? 90,
        pullbackMinRsi15m:        r.pullbackMinRsi15m        ?? 40,
        pullbackMaxRsi15m:        r.pullbackMaxRsi15m        ?? null,
        pullbackMinBbPosition5m:  r.pullbackMinBbPosition5m  ?? 0.35,
        pullbackMaxBbPosition5m:  r.pullbackMaxBbPosition5m  ?? 0.9,
        pullbackRequire5mAboveSupertrend:  r.pullbackRequire5mAboveSupertrend  ?? true,
        pullbackRequire15mAboveSupertrend: r.pullbackRequire15mAboveSupertrend ?? true,
        pullbackRequire15mBullishSupertrend: r.pullbackRequire15mBullishSupertrend ?? true,
      };
    })(),
  },
  ...
  strategy: {
    ...
    defaultBinsAbove:  u.defaultBinsAbove ?? 0,
    maxBinsAbove:      u.maxBinsAbove     ?? 20,
  },
